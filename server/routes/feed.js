...
router.get("/", async (req, res) => {
    ...
    try {
        let sql = "SELECT F.FEEDNO, F.USERID, F.CONTENT, F.CDATETIME, I.IMGNO, I.IMGPATH, I.IMGNAME, U.PROFILE_IMG, U.USERNAME " 
                + "FROM P_FEED F INNER JOIN P_FEED_IMG I ON F.FEEDNO = I.FEEDNO "
